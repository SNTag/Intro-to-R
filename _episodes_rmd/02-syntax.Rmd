...
**We already see** that `round()` can take an additional argument, called `digits`, that specifies how much rounding is requested. 
...
In addition to the usual `?` and `??` for help, or `help()`, you can also use the `args` function to find out just the arguments of a function. 
